...
<script type="text/x-handlebars" data-template-name="desktop">
    <div class="containerAll">
        <div class="statusbar">
            ...
            {literal}
                {{#if connected}}
                    <span style="color:#10b981;font-weight:600;letter-spacing:0.05em;">● Connected</span>
                    <div class="utilities-container">
                        ...
                        <div class="Extensions-Calls-Count">
                          <div class="Registered">
                            ...
                            <span class="Count-Registered" ></span>
                          </div>
                          <div class="NotRegistered">
                            <span>Extensions Offline</span><br>
                            <span class="Count-NotRegistered" ></span>
                          </div>
                        </div>
                    </div>

                {{else}}
                    <span style="color:#ef4444;font-weight:600;letter-spacing:0.05em;">◌ Connecting...</span>
                {{/if}}
            {/literal}
        </div>
